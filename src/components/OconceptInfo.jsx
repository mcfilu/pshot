  ...
  return (
    <div className={`flex w-full flex-row  md:min-h-[55vh]   `}>
        ...
        <div className={`hidden md:flex flex flex-col w-[55%] p-[2vh]  items-center`}>
            ...
            <NavLink to={`/o-concept-treatment-in-london`}><button className={` text-[3vh] px-[2vh] py-[0.5vh] bg-black border-gold1 border-2 text-gold1 hover:bg-white mt-[5vh]  md:mt-[2vh]`}>Read More</button></NavLink>
        </div>

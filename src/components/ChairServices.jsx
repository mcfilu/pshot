...
import { chair1, shockwave1, oshot1, chair3, pshot1} from '../assets';
    ...
    <div className={`flex flex-col md:flex-row w-full justify-between mt-[2vh] md:min-h-[65vh] `}>
        ...
        <NavLink to={`/`}>
            <div  className={`relative flex w-full h-[40vh] overflow-hidden bg-black`}>
                <img className={`flex w-full h-full  ease-in-out duration-500 object-cover ${hov1 ? 'scale-125' : ''}`} src={pshot1}></img>

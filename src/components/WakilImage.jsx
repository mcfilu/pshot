...
import {  sherif_bg, sherif_bg_mobile } from '../assets'
...
const WakilImage = () => {
  return (
    ...
    // </div>
    <div className={`relative`}>
    <img className={`hidden md:flex w-screen h-screen object-cover`} src={sherif_bg }></img>
    <img className={`md:hidden w-screen h-screen object-cover`} src={sherif_bg_mobile }></img>

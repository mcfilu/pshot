...
import {  oshot, boobs1, clinic2} from '../assets';
...
//     </div>
        ...
        <div  className={`flex flex-col md:flex-row w-full justify-between mt-[2vh] md:min-h-[70vh] `}>
            ...
            <div onMouseEnter={() => setHove1((prev) => !prev)} onMouseLeave={() => setHove1((prev) => !prev)} className={`relative flex flex-col  bg-gold1  w-[100%] md:w-[29%]  shadow-[0px_0px_50px_2px_#744210] hover:ease-in-out duration-500`}>
            ...
            <div onMouseEnter={() => setHove3((prev) => !prev)} onMouseLeave={() => setHove3((prev) => !prev)} className={`relative flex flex-col  bg-gold1   w-[100%] md:w-[29%] mt-[10vh] md:mt-[0px] shadow-[0px_0px_50px_2px_#744210] hover:ease-in-out duration-500`}>

...
const ContactConsultation = () => {
  return (
    <div className={`flex w-full flex-row min-h-[60vh]  md:pr-[0px] md:p-[2vh] `}>
        <div className={`hidden md:flex w-[50%] flex items-center`}>
            {/* <video src={BloodCells} autoPlay loop muted className={`rounded-[9px] object-cover h-[100%]`}></video> */}
            <img className={`flex w-full  `} src={sherif_consultation}></img>
        </div>
        ...
        <div className={`md:hidden flex flex-col items-center `}>
            ...
            <img className={`w-full h-full object-cover `} src={sherif_consultation}></img>

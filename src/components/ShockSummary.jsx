            ...
            <div className={` w-[100%] mx-auto h-[100%]`}>
                ...
                <div className={`flex flex-row justify-between px-[3vh] my-[5vh]`}>
                    <div className="inner-item flex flex-col items-center text-white">
                        ...
                        <h4 className="text-[1.7vh] text-center w-[11vw] font-medium">Approximately 20 minutes per session,</h4>
                    ...
                    <div className="inner-item flex flex-col items-center text-white">
                        ...
                        <h4 className="text-[1.7vh] text-center font-medium w-[11vw]">6 or 12 weekly session</h4>
                ...
                <div>
                    ...
                    <div className={`flex flex-row`}>
                        ...
                        <p className="text-[1.7vh] font-light text-white w-[70%]">None reported so far.</p>
                    </div>
...
with the most significant changes around 1 month after the last session.
            ...
            <div onMouseEnter={() => setHove(true)}  className={`absolute bg-gold1  ease-in-out duration-500 ${hov ? 'bg-opacity-100' : 'bg-opacity-90'} top-[22%] -right-[14.5vw] w-[19vw] h-[38vh] rounded-[9px] p-[2vh] `}>
                    ...
                    <h1 className={`font-poppins font-bold text-[5vh] `}>£ 500</h1>

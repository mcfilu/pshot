...
const ContactBooking = () => {
  return (
    <div className={`flex w-full flex-row min-h-[60vh]  md:pr-[0px] md:p-[2vh] `}>
        ...
        <div className={`hidden md:flex w-[45%] flex items-center `}>
            {/* <video src={BloodCells} autoPlay loop muted className={`rounded-[9px] object-cover h-[100%]`}></video> */}
            <img className={`flex w-full h-full object-cover `} src={clinic_reception}></img>
        </div>

        <div className={`md:hidden flex flex-col items-center `}>
            <p className={`flex text-gold text-[6vh] text-center text-gold1 font-header`}>Booking Process</p>
            <img className={`w-full h-full object-cover `} src={clinic_reception}></img>

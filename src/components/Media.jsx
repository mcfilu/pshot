  ...
  return (
    <div className="flex flex-col md:flex-row  w-full   p-[2vh] md:pr-[0px] ">
      <div className="flex flex-col md:w-1/3 justify-center md:pr-[2vh]">
        <h1 className="text-gold1 text-[5vh] text-start md:text-left font-header mt-[2vh]">As Seen On</h1>
        <p className="text-white text-start md:text-justify text-[2.1vh] font-main mt-[3vh]">Dr Sherif Wakil is regularly interviewed by the mainstream press as an expert in the subject of sexual health and well-being.</p>
      </div>
